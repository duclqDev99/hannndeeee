    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme) {
            ...
            $theme->asset()->usePath()->add('custom-st1', 'css/custom-st1.css', [], [], $version);
            ...
            $theme->asset()->container('footer')->usePath()->add('odometer', 'js/odometer.min.js', [], [], $version);
            ...
            $theme->asset()->container('footer')->usePath()->add('custom', 'js/custom.js', [], [], $version);
