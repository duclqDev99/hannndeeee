            ...
            window.onChangeSwatchesSuccess = function(res) {
                ...
                if (res) {
                    ...
                    if (res.error) {
                        ...
                        let imageHtmlAf = ''
                        let countImgAf = 0;
                        res.data.image_with_sizes.medium.forEach(function(item, index) {
                            if(index < 2){
                                imageHtmlBe += `
                                <div class="wrapper box-shadow banner-effect" data-order="${index+1}">
                                    <div class="product__gallery" data-arrow="true">
                                    <div class="item"><a href="${item}"><img src="${item}" alt="${res.data.name}"/></a></div>
                                    </div>
                                </div>
                                `
                                countImgBe++
                                ...
                                imageHtmlAf += `
                                <div class="wrapper box-shadow banner-effect" data-order="${index+2}">
                                    <div class="product__gallery" data-arrow="true">
                                    <div class="item"><a href="${item}"><img src="${item}" alt="${res.data.name}"/></a></div>
                                    </div>
                                </div>
                        ...
                        let productThumbDetail = product.find('.product__thumbnail_detail')
                        productThumbDetail.find('.wrapper').remove()
                        
                        // primary.slick('unslick')
                        // second.slick('unslick')

                        productThumbDetail.prepend(imageHtmlBe)
                        productThumbDetail.append(imageHtmlAf)
