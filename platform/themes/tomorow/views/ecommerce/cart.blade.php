                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="product__content">
                                                            <a href="{{ $product->original_product->url }}" title="{{ $product->original_product->nameHomepage }}">{{ $product->original_product->nameHomepage }} @if ($product->isOutOfStock()) <span class="stock-status-label">({!! $product->stock_status_html !!})</span> @endif</a>
