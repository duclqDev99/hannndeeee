                    ...
                    <tbody>
                        <tr class="pr_image">
                            ...
                            @foreach($products as $product)
                                <td class="row_img">
                                    <a href="{{ $product->original_product->url }}"><img src="{{ RvMedia::getImageUrl($product->image, 'thumb', false, RvMedia::getDefaultImage()) }}" alt="{{ $product->nameHomepage }}" loading="lazy"/></a>
                                </td>
                            @endforeach
                        </tr>
                        <tr class="pr_title">
                            ...
                            @foreach($products as $product)
                                <td class="product_name">
                                    <h5><a href="{{ $product->original_product->url }}">{!! BaseHelper::clean($product->nameHomepage) !!}</a></h5>
                                </td>
                            @endforeach
                        </tr>
                        <tr class="pr_price">
