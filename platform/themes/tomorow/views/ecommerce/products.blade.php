    ...
    <div class="page__content">
        <div class="container-fluid">
            <div class="shop shop--sidebar">
                <div class="container-fluid" style="max-width: 1900px;margin: 0 auto;">
                    <form action="{{ URL::current() }}" method="GET">
                        <div class="shop__header">
                            @include(Theme::getThemeNamespace() . '::views/ecommerce/includes/sort')
                            <a class="panel-trigger btn--custom btn--rounded btn--outline" href="#filter-product">
                                    ...
                                    @if ($products->count() > 0)
                                        <div class="row">
                                            @foreach($products as $product)
                                                <div class="widget-item col-lg-4 col-md-6 col-sm-12">
