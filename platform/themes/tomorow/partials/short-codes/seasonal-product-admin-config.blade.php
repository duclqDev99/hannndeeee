...
<div class="form-group">
    ...
    <input type="text" id="subtitle" name="subtitle" class="form-control" value="{{Arr::get($attributes, 'subtitle')}}" placeholder="Nhập phụ đề">
</div>
<div class="form-group">
    <label class="control-label">{{ __('Hình ảnh banner') }}</label>
    <div class="image-box image-seasion-image-banner" action="select-image">
        ...
        <div data-bb-toggle="upload-from-url">
            ...
            <a href="javascript:void(0)" class="mt-1" data-bs-toggle="modal"
                data-bs-target="#rv_media_modal" data-bb-target=".image-seasion-image-banner">
                Add from URL
            </a>
        </div>
    </div>
