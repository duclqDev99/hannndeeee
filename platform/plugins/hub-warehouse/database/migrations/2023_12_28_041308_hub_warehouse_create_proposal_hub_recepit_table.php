...
return new class () extends Migration {
    ...
    {
        Schema::create('hb_proposal_hub_recepits', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('hb_proposal_hub_recepit_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('hb_proposal_hub_recepits');
        Schema::dropIfExists('hb_proposal_hub_recepit_detail');
    }
};
