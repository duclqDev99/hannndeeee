...
class HubIssueHelper
{

    public function makeMaterialPDF(HubIssue $invoice): PDFHelper|Dompdf
    {
    ...
    public function downloadInvoice(HubIssue $invoice): Response
    {
        return $this->makeMaterialPDF($invoice)->download(sprintf('material-%s.pdf', $invoice->proposal_code));
    }

    public function streamInvoice(HubIssue $invoice): Response
    {
    ...
    protected function getDataForInvoiceTemplate(HubIssue $invoice): array
    {
    ...
    public function getDataForPreview(): HubIssue
    {
        $matial = new HubIssue([
            'id' => 'INV-1',
