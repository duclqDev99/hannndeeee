...
class HubReceiptHelper
{
    ...
    public function makeMaterialPDF(HubReceipt $invoice): PDFHelper|Dompdf
    {
    ...
    public function downloadInvoice(HubReceipt $invoice): Response
    {
        return $this->makeMaterialPDF($invoice)->download(sprintf('receipt  -%s.pdf', $invoice->receipt_code));
    }

    public function streamInvoice(HubReceipt $invoice): Response
    {
    ...
    protected function getDataForInvoiceTemplate(HubReceipt $invoice): array
    {
        ...
        $data = [
            ...
            'receipt_code' => get_proposal_receipt_product_code_not_prefix($invoice->receipt_code),
    ...
    public function getDataForPreview(): HubReceipt
    {
        $matial = new HubReceipt([
            'id' => 'INV-1',
