...
class ProposalProductIssueHelper
{

    public function makeMaterialPDF(ProposalProductIssue $invoice): PDFHelper|Dompdf
    {
    ...
    public function downloadInvoice(ProposalProductIssue $invoice): Response
    {
        return $this->makeMaterialPDF($invoice)->download(sprintf('material-%s.pdf', $invoice->proposal_code));
    }

    public function streamInvoice(ProposalProductIssue $invoice): Response
    {
    ...
    protected function getDataForInvoiceTemplate(ProposalProductIssue $invoice): array
    {
        ...
        foreach ($invoice->proposalProductIssueDetail as $key => $value) {
            $totalQuantity = 0;
        ...
        $data = [
            ...
            'proposal_detail' => $invoice->proposalProductIssueDetail,
            ...
            'receipt_code' => '123123123'
        ];
        return apply_filters('ecommerce_invoice_variables', $data, $invoice);
    }

    public function getDataForPreview(): ProposalProductIssue
    {
        $matial = new ProposalProductIssue([
            'id' => 'INV-1',
