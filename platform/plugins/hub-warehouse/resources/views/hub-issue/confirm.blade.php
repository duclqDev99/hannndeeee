...
@section('content')
                    ...
                    <div class="flexbox-layout-sections">
                        <div class="flexbox-layout-section-primary mt20">
                            <div class="card ui-layout__item">
                                <form method="POST" id="submit_form" action="{{ route('hub-issue.confirm', $productIssue) }}"
                                    class="form-2">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @php
                                                        ...
                                                        $date_type = null;
                                                    @endphp
                                                    @if ($productIssue->proposal->is_warehouse == 5 && $productIssue->proposal->policy)
                                                        <div>
                                                            @php
                                                                $policy = $productIssue->proposal->policy;
                                                                $value = 0;
                                                                            ...
                                                                            <td class="pl5 p-r5" width="20%">
                                                                                <span style="white-space: nowrap;">Đã quét:
                                                                                    <input type="text" class=""
                                                                                        name="product[{{ $orderProduct->id }}][quantity_scan]"
                                                                                        value="{{ $orderProduct->quantity_scan }}"
                                                                                        hidden="">
                                                                                    <span
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="denyForm" method="post" action="{{ route('hub-issue.denied', $productIssue->id) }}">
                        @csrf
    ...
    @include('plugins/qr-scan::scan-warehouse-issue', [
        ...
        'url_confirm' => 'hub-issue.createBatchIssue',
        'date_type' => $date_type,
        'dateAcceipt' => $dateAcceipt,
    ])
    <script>
