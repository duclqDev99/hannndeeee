...
namespace Botble\ViettelPost\Commands;
...
#[AsCommand('cms:viettel-post:init', 'ViettelPost initialization')]
class InitViettelPostCommand extends Command implements PromptsForMissingInput
{
    ...
    public function handle(): int
    {
        ...
        $settings = [
            ...
            'shipping_viettel_post_test_key' => $key,
            'shipping_viettel_post_status' => $key ? '1' : '0',
        ];
