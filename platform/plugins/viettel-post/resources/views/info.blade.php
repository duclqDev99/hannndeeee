    ...
    <div class="row">
        <div class="col-12 my-3 text-center">
            <div>
                ...
                <div>
                    <small
                        class="text-secondary">{{ trans('plugins/viettel-post::viettel-post.estimated_days', ['day' => $days]) }}</small>
                </div>
            </div>
        </div>
        <div class="col-12 my-2">
            @include('plugins/viettel-post::address')
        </div>
        ...
        <div class="col-12 my-2">
            <div class="row">
                ...
                <div class="col-6">
                    @if ($cod = Arr::get($shipmentViettelPost, 'extra.COD'))
                        <span
                            class="fw-bold"
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>{{ trans('plugins/viettel-post::viettel-post.order_amount') }}</td>
        ...
        <div class="col-12 mt-2">
            <span class="fw-bold fs-5">{{ trans('plugins/viettel-post::viettel-post.parcel') }}</span>
            @php
                $parcel = Arr::get($shipmentViettelPost, 'parcels.0');
        ...
        @php
            $url = route('ecommerce.shipments.viettel-post.transactions.create', $shipment->id);
            $isShowButton = true;
            if (!is_in_admin(true)) {
                if (is_plugin_active('marketplace')) {
                    $url = route('marketplace.vendor.orders.viettel-post.transactions.create', $shipment->id);
                }
                ...
                <div class="col-12 my-3">
                    <div class="alert alert-warning">
                        <small>
                            ...
                            <span>{{ trans('plugins/viettel-post::viettel-post.note_5') }}</span>
                        </small>
                    </div>
                    <button
                        class="btn btn-primary get-new-rates"
                        data-url="{{ route('ecommerce.shipments.viettel-post.rates', $shipment->id) }}"
                        type="button"
                    >
                        {{ trans('plugins/viettel-post::viettel-post.recheck_rate') }}
                    </button>
                </div>
            @endif
        @endif
