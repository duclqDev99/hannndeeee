...
class MaterialIssuePdfController extends BaseController
{
    ...
    public function getGenerateMatial(ExportBillRequest $request, MaterialIssueHelper $materialHelper)
    {
        $data = MaterialOutConfirm::with('proposalOutDetail')->find($request->id);
