 ...
 */
class MaterialReceiptConfirmDetail extends BaseModel
{
    protected $table = 'wh_material_receipt_confirm_details';
    ...
    public function getActualMaterial()
    {
        $actualMaterial = $this->belongsTo(ActualReceipt::class, 'receipt_id', 'receipt_id');
        return $actualMaterial->getActualMaterialById($this->id);
    }
