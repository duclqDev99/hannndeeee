...
<body>
    ...
    <table>
        ...
        <tr>
            <td class="">
                - Nhập tại kho: <span class="text-bold"> {{invoice['warehouse_name']}}</span>			
            </td>
            <td class="">
    ...
    <table id="table_material" class="line-items-container table-bordered">
        ...
        <tr>
            ...
            <th class="heading-quantity center">Thực nhập</th>
        </tr>
        </thead>
        <tbody>
        {% if proposal_detail %}
            {% for index,val in proposal_detail %}
                <tr>
                    ...
                    <td class="center">{{actual_detail[index]['material_quantity']}}</td>
    ...
    <div class="signature">
        ...
        <table class="invoice-info-container" style="margin-top: 20px" >
            <tr class="info__company group-signature">
                ...
                <td style="text-align: center">
                    <span  class="text-bold">Người giao hàng</span>
                    <p class="italic">(Ký, họ tên)</p>
                </td>
