...
if(! function_exists('get_products_uniform_collection')) {
    function get_products_uniform_collection(){
        $products = ProductCategory::query()->whereHas('products')->first()?->products()->limit(6)->get();
        return $products;
    }
}


if (! function_exists('get_featured_products_for_homepage')) {
    function get_featured_products_for_homepage(array $params = []): Collection|LengthAwarePaginator|Product|null
    {
        $params = array_merge([
            'condition' => [
                'ec_products.is_featured' => 1,
                'ec_products.is_variation' => 0,
                'ec_products.is_show_home' => 1,
            ],
            'take' => null,
            'order_by' => [
                'ec_products.order' => 'ASC',
...
if (! function_exists('get_trending_products_homepage')) {
    function get_trending_products_homepage(array $params = []): Collection|LengthAwarePaginator|Product|null
    {
        $params = array_merge([
            'condition' => [
                'ec_products.is_variation' => 0,
...
if (! function_exists('get_related_products_homepage')) {
    function get_related_products_homepage(Product $product, int $limit = 4): Collection|LengthAwarePaginator|Product|null
    {
        $params = [
            'condition' => [
                'ec_products.is_variation' => 0,
...
if (! function_exists('get_cross_sale_products_homepage')) {
    function get_cross_sale_products_homepage(Product $product, int $limit = 6, array $with = []): EloquentCollection
    {
        $with = array_merge(EcommerceHelper::withProductEagerLoadingRelations(), $with);
