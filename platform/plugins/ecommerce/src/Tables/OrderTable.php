...
class OrderTable extends TableAbstract
{
    ...
    public function ajax(): JsonResponse
    {
        $data = $this->table
            ...
            ->editColumn('orderer', function (Order $item) {
                if (! is_plugin_active('payment')) {
                    return '&mdash;';
                }
            ...
            ->editColumn('orderer_name',function(Order $item) {
                return $item->showroomOrder->where->name ?? '&mdash;';
            })
    ...
    public function query(): Relation|Builder|QueryBuilder
    {
        ...
        $query = $this
            ...
            ->with(['payment.customer' => function($query) {
    ...
    public function columns(): array
    {
        $columns = [
            ...
            Column::make('orderer')
                ...
                ->orderable(false),
            Column::make('orderer_name')
                ->title(trans('plugins/ecommerce::order.orderer_name'))
                ->alignStart()
                ->orderable(false),
