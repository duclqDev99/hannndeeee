...
class WishlistController extends BaseController
{
    ...
    public function store(int|string $productId, Request $request)
    {
        ...
        return $this
            ...
            ->setMessage(
                $isAdded
                ? __('Added product :product successfully!', ['product' => $product->nameHomepage])
                : __('Removed product :product from wishlist successfully!', ['product' => $product->nameHomepage])
            )
            ->setData([
    ...
    public function destroy(int|string $productId)
    {
        ...
        return $this
            ->httpResponse()
            ->setMessage(__('Removed product :product from wishlist successfully!', ['product' => $product->nameHomepage]))
