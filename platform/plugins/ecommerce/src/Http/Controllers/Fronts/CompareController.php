...
class CompareController extends BaseController
{
    ...
    public function store(int|string $productId)
    {
        ...
        if (! $duplicates->isEmpty()) {
            return $this
                ->httpResponse()
                ->setMessage(__(':product is already in your compare list!', ['product' => $product->nameHomepage]))
                ->setError();
        }
        ...
        return $this
            ->httpResponse()
            ->setMessage(__('Added product :product to compare list successfully!', ['product' => $product->nameHomepage]))
    ...
    public function destroy(int|string $productId)
    {
        ...
        return $this
            ->httpResponse()
            ->setMessage(__('Removed product :product from compare list successfully!', ['product' => $product->nameHomepage]))
            ->setData(['count' => Cart::instance('compare')->count()]);
    }
}
