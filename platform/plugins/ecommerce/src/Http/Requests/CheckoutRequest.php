...
use Botble\Showroom\Rules\CheckUniqueEmailWithVID;
...
class CheckoutRequest extends Request
{
    public function rules(): array
    {
        ...
        if (!auth('customer')->check()) {
            ...
            $rules['address.email'] = ['required', 'email', 'max:60', 'min:6', new CheckUniqueEmailWithVID()];
