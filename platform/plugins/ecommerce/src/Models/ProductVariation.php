...
use Botble\HubWarehouse\Models\QuantityProductInStock as QuantityProductInHubStock;
...
class ProductVariation extends BaseModel
{
    ...
    {
        return $this->hasMany(QuantityProductInStock::class, 'product_id', 'product_id')->where('quantity', '>', '0');
    }
    public function productAllStock(): HasMany
    {
        return $this->hasMany(QuantityProductInStock::class, 'product_id', 'product_id');
    }

    public function productAllHubStock(): HasMany
    {
        return $this->hasMany(QuantityProductInHubStock::class, 'product_id', 'product_id');
    }
}
