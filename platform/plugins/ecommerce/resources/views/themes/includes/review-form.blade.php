<div @class(['col-12', 'col-md-8' => $showAvgRating])>
    ...
    @guest('customer')
        <p class="text-danger">
            {!! BaseHelper::clean(
                __('Please <a href=":link">login</a> to write reviews!', ['link' => route('customer.login')]),
            ) !!}
        </p>
    @endguest
        ...
        <x-core::form :url="route('public.reviews.create')" method="post" :files="true">
            ...
            <div role="alert" class="image-upload-info alert alert-info p-2">
                <div class="small d-flex align-items-center gap-1">
                    ...
                    {{ __('You can upload up to :total photos, each photo maximum size is :max kilobyter', [
