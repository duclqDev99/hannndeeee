                    ...
                    @if ($order->address->name)
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    @if (!$order->completed_at && $order?->payment?->payment_channel == 'bank_transfer' )
                                    <div id="widget__render-img" class="d-flex justify-content-center">
                                        <input type="hidden" name="" id="order-id" value="{{$order->id}}">
                                        <img src="" class="img-fluid" style="max-width: 100px;" alt="Not found">
                                    </div>
                                    @endif
                                </div>
                            </div>
