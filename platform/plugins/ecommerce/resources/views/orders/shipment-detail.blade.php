<x-core::card.body class="d-print-none">
    <x-core::datagrid>
        <x-core::datagrid.item>
            ...
            <a href="{{ route('showroom.shipments.edit', $shipment->id) }}" target="_blank">
...
@if (
    ...
    <x-core::card.footer class="shipment-actions-wrapper btn-list">
        @if (in_array($shipment->status, [
            ...
            <x-core::button type="button" class="btn-cancel-shipment" :data-action="route('orders.cancel-shipment', $shipment->id)">
