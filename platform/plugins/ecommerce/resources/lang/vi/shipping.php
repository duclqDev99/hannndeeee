...
return [
    ...
    'ghtk_statuses' => [
        'cancel' => 'Hủy đơn hàng',
        'waiting_pending' => 'Chưa tiếp nhận',
        'has_received' => 'Đã tiếp nhận',
        'received_the_goods' => 'Đã lấy hàng/Đã nhập kho',
        'delivering' => 'Đã điều phối giao hàng/Đang giao hàng',
        'delivered' => 'Đã giao hàng/Chưa đối soát',
        'for_control' => 'Đã đối soát',
        'not_get_the_goods' => 'Không lấy được hàng',
        'delay_get_the_goods' => 'Hoãn lấy hàng',
        'not_deliver_goods' => 'Không giao được hàng',
        'delay_delivery' => 'Delay giao hàng',
        'repayment_debt_has_been_checked' => 'Đã đối soát công nợ trả hàng',
        'picking_up_goods' => 'Đã điều phối lấy hàng/Đang lấy hàng',
        'reimbursement_order' => 'Đơn hàng bồi hoàn',
        'returning_the_goods' => 'Đang trả hàng (COD cầm hàng đi trả)',
        'returned_the_goods' => 'Đã trả hàng (COD đã trả xong hàng)',
        'shipper_has_received_the_goods' => 'Shipper báo đã lấy hàng',
        'shipper_did_not_receive_the_goods' => 'Shipper (nhân viên lấy/giao hàng) báo không lấy được hàng',
        'shipper_noti_delay_get_the_goods' => 'Shipper báo delay lấy hàng',
        'shipper_noti_delivered' => 'Shipper báo đã giao hàng',
        'shipper_noti_not_delivery' => 'Shipper báo không giao được giao hàng',
        'shipper_noti_delay_delivered' => 'Shipper báo delay giao hàng',
    ],
    'cod_statuses' => [
