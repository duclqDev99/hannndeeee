    ...
    Route::group([
        ...
        Route::group(['prefix' => 'ecommerce'], function () {
            Route::prefix('settings')->group(function () {
                ...
                Route::get('pick-address-item', [
                    'as' => 'ecommerce.settings.pick-address-item',
                    'uses' => 'ShippingSettingController@getSettingPickAddressItem',
                ]);

                Route::post('setting-pick-address', [
                    'as' => 'ecommerce.settings.shipping.pick-address',
                    'uses' => 'ShippingSettingController@pickAddress',
                ]);
