...
return [
    ...
    'create_new_order' => 'Tạo một sản phẩm mới',
    ...
    'edit_order_customer' => 'Cập nhật đơn',
    ...
    'order_was_canceled_at' => 'Đơn hàng bị huỷ vào lúc',
    'return_order' => 'Return order',
    'order_returned' => 'Order returned',
    'order_was_returned_at' => 'Order was returned at',
    'completed' => 'Completed',
    'uncompleted' => 'Đang tiến hành',
    'sku' => 'SKU',
    'warehouse' => 'Warehouse',
    'sub_amount' => 'Số tiền sản phẩm',
    'coupon_code' => 'Coupon code: ":code"',
    'shipping_fee' => 'Shipping fee',
    'tax' => 'Tax',
    'refunded_amount' => 'Refunded amount',
    'amount_received' => 'The amount actually received',
    'download_invoice' => 'Tải đơn hàng',
    'print_invoice' => 'In đơn hàng',
    'add_note' => 'Add note...',
    ...
    'create_a_new_product_customer' => 'Tạo một sản phẩm mới',
    'out_of_stock' => 'Out of stock',
    'products_available' => 'product(s) available',
    'no_products_found' => 'No products found!',
    'note' => 'Ghi chú',
    'note_for_order' => 'Ghi chú...',
    'amount' => 'Amount',
    ...
    'confirm_payment_and_create_order' => 'Xác nhận thông tin và tạo đơn đặt hàng',
    'confirm_payment_and_create_pro_re' => 'Xác nhận thông tin và tạo yêu cầu sản xuất',
    'paid' => 'Trả',
    ...
    'total' => 'Total',
    'action' => 'Action',
    'add_product' => 'Tạo sản phẩm mới',
    'add_new_product' => 'Tạo sản phẩm mới',
    'enter_free_text' => 'Enter free text',
    'promotion_discount_amount' => 'Số tiền khuyến mãi',
    'add' => 'Thêm',
    'store' => 'Cửa hàng',
    'please_choose_product_option' => 'Vui lòng chọn sản phẩm',
    ...
    'search_or_create_new_for_customer' => 'Tìm kiếm hoặc tạo khách hàng mới',
    'search_or_create_new_for_product' => 'Tìm kiếm hoặc tạo sản phẩm mới',
    ...
    'code_order_placeholder' => 'Nhập mã đơn hàng',
    'title' => 'Tiêu đề đơn hàng',
    'title_placeholder' => 'Nhập tiêu đề',
    'expected_date' => 'Ngày dự kiến',
    'send_design' => 'Gửi đến bộ phận tiếp theo',
    'product_sample' => 'Sản phẩm mẫu',
    'product_ecomemerce' => 'Sản phẩm thương mại',
    'send_cancel' => 'Huỷ đơn mua hàng',
    'type_order' => 'Loại đơn',
    'order_sample' => 'Đơn hàng mẫu',
    'order_official' => 'Đơn hàng chính thức',
    'order_additional' => 'Đơn hàng bổ sung',
    'order_processing' => 'Đơn hàng đang thực hiện',
    'order_was_processed_at' => 'Đơn hàng bắt đầu vào lúc',
    'option_order' => 'Tính chất đơn hàng',
    'option_pro_re' => 'Loại sản xuất',
    'print' => 'In',
    'embroider' => 'Thuê',
    'fashion' => 'Fashion',
    'dye' => 'Nhuộm',
    'general_code' => 'Số YCSX',
    'placeholder_general_code' => 'eg: DH0000001',
    'delivery_location' => 'Địa điểm nhận hàng',
    'placeholder_delivery_location' => 'Chi tiết địa điểm',
    'delivery_method' => 'Phương thức giao hàng',
    'placeholder_product_name' => 'eg: Áo, quần, nón',
    'placeholder_sku' => 'eg: HS-001',
    'placeholder_unit' => 'eg: Chiếc',
    'placeholder_price' => '0',
    'placeholder_color' => 'eg: Xanh',
    'placeholder_size' => 'eg: XL,..',
    'placeholder_ingredient' => 'Chi tiết thành phần',
    'placeholder_description' => 'Mô tả',
    'self_shipment' => 'Tự ship hàng online',
    'shipper' => 'Thuê shipper giao hàng trực tuyến',
    'freight_transport' => 'Liên kết với đơn vị vận chuyển hàng hóa',
    'post_office' => 'Ship hàng online qua bưu điện',
    'service_transport' => 'Gửi hàng qua dịch vụ vận tải',

    //Production requirements
    'create_pro_re' => 'Tạo yêu cầu sản xuất',
    'title_pro_pre' => 'Mục đích sản xuất',
