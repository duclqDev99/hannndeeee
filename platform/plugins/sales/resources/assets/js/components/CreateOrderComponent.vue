<template>
    <div class="row row-cards">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="mb-3 position-relative">
                                <label class="form-label" for="txt-title">{{ __('order.title') }}</label>
                                <input
                                    v-model="child_order.title"
                                    ref="titleInput"
                                    name="title"
                                    class="form-control"
                                    :placeholder="__('order.title_placeholder')"
                                />
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="mb-3 position-relative">
                                <label class="form-label" for="txt-expected-date">{{ __('order.general_code') }}</label>
                                <div class="input-group">
                                    <input
                                        v-model="child_order.general_code"
                                        ref="generalCodeInput"
                                        type="text"
                                        name="general_code"
                                        class="form-control"
                                        :placeholder="__('order.placeholder_general_code')"
                                    />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="mb-3 position-relative">
                                <label class="form-label" for="txt-expected-date">{{ __('order.expected_date') }}</label>
                                <div class="input-group">
                                    <input
                                        v-model="child_order.expected_date"
                                        type="date"
                                        name="expected_date"
                                        class="form-control"
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3 position-relative">
                                <label class="form-label" for="txt-expected-date">{{ __('order.delivery_location') }}</label>
                                <div class="input-group">
                                    <input
                                        v-model="child_order.delivery_location"
                                        ref="deliveryLocationInput"
                                        type="text"
                                        name="delivery_location"
                                        class="form-control"
                                        :placeholder="__('order.placeholder_delivery_location')"
                                    />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="mb-3 position-relative">
                                <label class="form-label" for="txt-expected-date">{{ __('order.delivery_method') }}</label>
                                <div class="input-group">
                                    <select
                                        v-model="child_delivery_method_selected"
                                        id="delivery_method"
                                        class="form-control"
                                        @change="selectDeliveryMethod"
                                    >
                                        <option
                                        v-for="item in option_delivery_method"
                                        :value="item"
                                        >{{ __(`order.${item}`) }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="txt-product">{{ __('order.title_products') }}</label>
                        <div
                        ...
                        <div class="position-relative box-search-advance product">
                            <input
                                ...
                                :placeholder="__('order.search_or_create_new_for_product')"
                                ...
                                <div v-else class="list-group list-group-flush overflow-auto" style="max-height: 25rem">
                                    ...
                                    >
                                        <img
                                            ...
                                            class="me-2"
                                        />
                                        {{ __('order.create_a_new_product_customer') }}
                                    </a>
                                    <a
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            ...
                                            aria-hidden="true"
                                        ></span>
                                        <h4 class="d-inline-block mb-0">{{ child_total_amount_label }}</h4>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div class="btn-list">
                            ...
                            >
                            <span v-if="child_order.id"> {{ __('order.update_order') }}</span>
                            <span v-else> {{ __('order.create_order') }}</span>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-3">
                    ...
                    <div class="card-body">
                        <div class="position-relative box-search-advance customer">
                            <input
                                ...
                                :placeholder="__('order.search_or_create_new_for_customer')"
                            />

                            <div
                                class="card position-absolute w-100 z-2"
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h4 class="card-title">{{ __('order.type_order') }}</h4>
                </div>
                <div class="card-body">
                    <div class="position-relative box-search-advance customer">
                        <select
                            v-model="child_type_order_selected"
                            id="type_order"
                            class="form-control"
                            @change="selectTypeOrder"
                        >
                            <option
                            v-for="item in type_order"
                            :value="item"
                            >{{ __(`order.${item}`) }}</option>
                        </select>
                        <div
                            class="link_order mt-3"
                            :style="[loading ? { minHeight: '10rem' } : {}]"
                        >
                            <div v-if="loading" class="loading-spinner"></div>
                            <div class="form-group" v-if="child_type_order_selected != 'order_sample'">
                                <label for="link_order" class="mb-2"><strong>Chọn đơn hàng liên kết:</strong></label>
                                <select id="link_order" class="form-control">
                                    <option
                                        v-for="item in list_purchase_order"
                                        :value="item.id"
                                        :selected="order.link_order_id == item.id">{{ item.order_code }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h4 class="card-title">{{ __('order.option_pro_re') }}</h4>
                </div>
                <div class="card-body">
                    <div class="position-relative box-search-advance customer">
                        <select
                            v-model="child_option_order_selected"
                            id="type_order"
                            class="form-control"
                        >
                            <option
        ...
        <ec-modal
            ...
            :ok-title="child_order.id ? __('order.edit_order_customer') : __('order.create_order')"
            :cancel-title="__('order.close')"
...
export default {
    props: {
        ...
        option_order_selected: {
            type: String,
            default: 'print'
        },
        //Selection option order
        option_delivery_method: {
            type: Array,
            default: [
                'self_shipment',
                'shipper',
    ...
    data: function () {
        return {
            ...
            child_order: this.order,
            child_type_order_selected: this.type_order_selected,
            list_purchase_order: [],
            child_order_link_id: null,
            child_option_order_selected: this.option_order_selected,
            child_delivery_method_selected: this.delivery_method_selected,
        }
    },
    components: {
        ProductAction,
    ...
    created: function () {
        ...
        axios
            .get(route('order-production.list-link-order-production'))
            .then((res) => {
    ...
    mounted: function () {
        ...
        if (Object.keys(context.order).length !== 0) {
            this.title = context.child_order.title;
            this.expected_date = context.child_order.expected_date;
            this.note = context.child_order.description;

            this.general_code = context.child_order.general_code;
            this.delivery_location = context.child_order.delivery_location;
            this.delivery_method = context.child_order.delivery_method;

            this.child_type_order_selected = context.child_order.type_order.value;
            this.child_order_link_id = context.child_order.link_order_id;
            this.child_option_order_selected = context.child_order.option;
            this.child_order_link_id = context.child_order.link_order_id;
            this.child_delivery_method_selected =  context.child_order.delivery_method;
        }
        this.waitForElementToExist('select#link_order option').then(element => {
            $('select#link_order').select2();
            $('select#link_order').on('change', (event) => {
                this.child_order_link_id = $(event.target).val()
            })
        });
    ...
    methods: {
        ...
        loadListProductsAndVariations: function (page = 1, force = false, show_panel = true) {
            ...
            if (_.isEmpty(context.list_products.data) || force) {
                ...
                axios
                    .get(
                        route('order-production.get-all-products-and-variations', {
        ...
        selectProductVariant: function (product, refOptions) {
            ...
            context.child_products.push({ id: product.id, quantity: 1, options, is_sample: product.is_sample })
        ...
        checkDataBeforeCreateOrder: function (data = {}, onSuccess = null, onError = null) {
            ...
            axios
                .post(route('order-production.check-data-before-create-order'), formData, {
        ...
        getOrderFormData: function () {
            ...
            return {
                ...
                note: this.note,
                title: this.child_order.title,
                expected_date: this.child_order.expected_date,
                delivery_location: this.child_order.delivery_location,
                delivery_method: this.child_delivery_method_selected,
                ...
                type_order: this.child_type_order_selected,
                option_order: this.child_option_order_selected,
                order_link_id: this.child_order_link_id,
                general_code: this.child_order.general_code
            }
        },
        ...
        createOrder: function (event, paid = false) {
            ...
            //Kiểm tra trường tiêu đề đơn đặt hàng
            if(this.validateForm(formData.title, this.$refs.titleInput, paid, 'tiêu đề') === false) return

            //Kiểm tra trường ngày dự kiến đơn đặt hàng
            if(this.validateForm(formData.expected_date, this.$refs.expectedDateInput, paid, 'ngày dự kiến') === false) return

            if(this.validateForm(formData.customer_id, null, paid, 'khách hàng') === false) return

            let urlRoute = route('order-production.create.store');

            if(this.child_order.id){
                urlRoute = route('order-production.reoder.update', this.child_order)
            }

            axios
                .post(urlRoute, formData)
                .then((res) => {
                    let data = res.data.data
                    ...
                    if (res.data.error) {
                        ...
                        // setTimeout(() => {
                        //     window.location.href = route('order-production.index')
                        // }, 1000)
                    }
                })
                .catch((res) => {
        ...
        createProduct: function (event, product) {
            ...
            axios
                .post(route('order-production.create-product-when-creating-order'), product)
                .then((res) => {
                    if (res.data.error) {
                        Botble.showError(res.data.message)
                    } else {
        ...
        createNewCustomer: function (event) {
            ...
            axios
                .post(route('customer-purchase.create-customer-when-creating-order'), {
                    customer_id: context.child_customer_id,
                    first_name: context.child_customer_address.first_name,
                    last_name: context.child_customer_address.last_name,
                    ...
                    gender: context.child_customer_address.gender,
                })
                .then((res) => {
                    if (res.data.error) {
                        Botble.showError(res.data.message)
        ...
        validateForm: function(model, ref, paid, title) {
            if(model == null){
                Botble.showError(`Trường ${title} là bắt buộc!!`);
                if (paid) {
                    $event.emit('ec-modal:close', 'make-paid')
                } else {
                    $event.emit('ec-modal:close', 'make-pending')
        ...
        selectTypeOrder: function(event) {
            this.child_order_link_id = $('select#link_order :selected').val()
            return this.child_type_order_selected = event.target.value
        },
        selectDeliveryMethod: function(event) {
            return this.child_delivery_method_selected = event.target.value
        },
        selectOptionOrder: function(event) {
            return this.child_option_order_selected = event.target.value
        },
