...
@if ($step->status == 'pending')
    <div class="dropdown">
        <button class="btn" type="button" data-boundary="viewport" id="dropdownMenuButton1" data-bs-toggle="dropdown"
            aria-expanded="false">
            <i class="fa-solid fa-ellipsis"></i>
        </button>
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            @if (auth()->user()->hasPermission('purchase-order.confirm_order_production'))
                <li>
