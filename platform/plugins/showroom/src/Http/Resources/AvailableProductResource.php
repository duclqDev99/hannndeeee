...
class AvailableProductResource extends JsonResource
{
    public function toArray($request): array
    {
        ...
        return [
            ...
            'height' => $this->height,
            'wide' => $this->wide,
            'qrcode' => isset($this->qrcode) ? $this->qrcode->identifier : null,
            'length' => $this->length,
            ...
            'variations' => $this->variations->map(function ($item) use($identifier) {
                $item->product->qrcode = $item->product->getQrcodeIdentifierAttribute($identifier);
