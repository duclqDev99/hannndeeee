...
class ProposalIssueHelper
{
    ...
    public function makeMaterialPDF(ShowroomProposalIssue $invoice): PDFHelper|Dompdf
    {
    ...
    public function downloadInvoice(ShowroomProposalIssue $invoice): Response
    {
        return $this->makeMaterialPDF($invoice)->download(sprintf('material-%s.pdf', $invoice->proposal_code));
    }

    public function streamInvoice(ShowroomProposalIssue $invoice): Response
    {
    ...
    protected function getDataForInvoiceTemplate(ShowroomProposalIssue $invoice): array
    {
    ...
    public function getDataForPreview(): ShowroomProposalIssue
    {
        $matial = new ShowroomProposalIssue([
            'id' => 'INV-1',
