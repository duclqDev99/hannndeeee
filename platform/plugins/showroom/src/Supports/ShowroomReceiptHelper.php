...
class ShowroomReceiptHelper
{
    ...
    public function makeMaterialPDF(ShowRoomReceipt $invoice): PDFHelper|Dompdf
    {
    ...
    public function downloadInvoice(ShowRoomReceipt $invoice): Response
    {
        return $this->makeMaterialPDF($invoice)->download(sprintf('material-%s.pdf', $invoice->proposal_code));
    }

    public function streamInvoice(ShowRoomReceipt $invoice): Response
    {
    ...
    protected function getDataForInvoiceTemplate(ShowRoomReceipt $invoice): array
    {
            ...
            if(!empty($value->batch_id)){
                ...
                foreach ($productBatch as $proId => $product) {
                    ...
                    foreach ($invoice->actualReceipt->actualDetail as $key => $actualDetail) {
                        # code...
                        $dataProduct[$proId]['actual_qty'] = 0;
    ...
    public function getDataForPreview(): ShowRoomReceipt
    {
        $matial = new ShowRoomReceipt([
            'id' => 'INV-1',
