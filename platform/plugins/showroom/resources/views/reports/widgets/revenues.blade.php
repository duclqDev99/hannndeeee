<x-core::card class="report-chart-content" id="report-chart">
    <x-core::card.header>
        <h4 class="card-title">{{ trans('plugins/showroom::reports.sales_reports') }}</h4>
    </x-core::card.header>
    <x-core::card.body>
        <div class="row">
                ...
                @if (collect($count['revenues'])->count())
                    <div class="rp-card-chart position-relative mb-3">
                        ...
                        <div class="rp-card-information">
                            ...
                            @endforeach
                            <small>{{ trans('plugins/showroom::reports.total_earnings') }}</small>
                        </div>
                    </div>
...
@include('plugins/showroom::reports.widgets.chart-script')
