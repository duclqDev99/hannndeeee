                    ...
                    <div class="flexbox-layout-sections">
                        <div class="flexbox-layout-section-primary mt20">
                            <div class="card ui-layout__item">
                                <form method="POST" action="{{ route('showroom-receipt.confirm', $productIssue) }}"
                                    class="form-2">
                                    ...
                                    <div class="wrapper-content">
                                        ...
                                        <div class="card-body pd-all-20 p-none-t border-top-title-main">
                                            ...
                                            @php
                                                ...
                                                $groupedProducts = [];
                                                $batches = [];
                                                $groupedByOdd = $productIssue->receiptDetail->filter(function ($detail) {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="denyForm" method="post"
                        action="{{ route('showroom-receipt.denied', $productIssue->id) }}">
                        @csrf
