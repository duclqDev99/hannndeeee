                    ...
                    <div class="col-md-6">
                        <div class="info-group">
                            ...
                            <strong> {{ $productIssue->warehouse_name }}
                                - {{ $productIssue->warehouseReceipt->showroom->name }}
                                        ...
                                        <div class="wrapper-content">
                                            ...
                                            <div class="card-body pd-all-20 p-none-t m-3" id="accordion ">
                                                @foreach ($productIssue->receiptDetail as $orderProduct)
                                                    @php
                                                        $groupedByOddActual = $actualIssue->actualDetail->filter(function ($detail) {
                                                            return $detail->batch_id == null;
                                                        });
                                                    @endphp
                                                @endforeach
                                                <div id="table-wrapper" class="table-wrap m-3">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="myForm" action="{{ route('showroom-receipt.export-file') }}" method="POST">
                                    @csrf
