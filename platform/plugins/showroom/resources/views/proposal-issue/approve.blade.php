            ...
            <div class="flexbox-layout-sections">
                <div class="flexbox-layout-section-primary mt20">
                    <div class="card ui-layout__item">
                        <form id="approve" action="{{ route('showroom-proposal-issue.approve', $proposal) }}" method="post">
                            @csrf
                            ...
                            <div class="wrapper-content">
                                <div class="pd-all-20">
                                    <div class="card-header">
                                        <div>
                                            <h2 class="title">Thông tin yêu cầu trả hàng
                                                {{ BaseHelper::clean(get_proposal_receipt_product_code($proposal->proposal_code)) }}
                                            </h2>
                                            <div>
                                                <h3>
                                                    Mục đích: <strong>{{ $proposal->title }}</strong>
                                                </h3>
                                            ...
                                            <div class="col-md-6">
                                                <div class="info-group">
                                                    ...
                                                    <strong>{{ $proposal->warehouseIssue->name }} -
                                                        {{ $proposal->warehouseIssue?->showroom?->name }}
                                                    </strong>
                                                </div>
                                                <div>
                                                    Người đề xuất:
                                                    ...
                                                    <tr class="item__product">
                                                        ...
                                                        <td class="pl5 p-r5">
                                                            ...
                                                            <span style="white-space: nowrap;">Tồn kho:
                                                                {{ $quantity }} sản phẩm <input type="number"
                                                                    class="quantityStock"
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            max="{{ $quantity }}" placeholder="0" required hidden>
                                                        <input type="hidden"
                                                            name="product[{{ $orderProduct->product_id }}][is_batch]"
                                                            class="form-control" value="{{ $orderProduct->is_batch }}">
                                                ...
                                                <tr>
                                                    <td colspan="6" class="text-end h5">
                                                        <strong>Tống số lượng: </strong> <span class="widget__quantity"
                                                            data-tax="{{ $proposal->quantity }}">{{ $proposal->quantity }}
                                                            Sản phẩm</span>
                                                    </td>
                                                </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="denyForm" method="post"
                                            action="{{ route('showroom-proposal-issue.denied', $proposal->id) }}">
                                            @csrf
