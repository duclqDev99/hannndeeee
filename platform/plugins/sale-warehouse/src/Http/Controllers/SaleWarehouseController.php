...
class SaleWarehouseController extends BaseController
{
    public function index(SaleWarehouseTable $table)
    {
        PageTitle::setTitle(trans('plugins/sale-warehouse::sale-warehouse.name'));
