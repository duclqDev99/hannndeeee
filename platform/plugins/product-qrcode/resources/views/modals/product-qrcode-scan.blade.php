<div class="modal fade modal-blur" id="productCodeQrScanModal" tabindex="-1" data-select2-dropdown-parent="true"
    aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Quét QR kiểm tra thông tin sản phẩm</h5>
                        ...
                        <div class="card border-0 position-relative h-100">
                            ...
                            <div class="card-body p-0 d-flex flex-column">
                                ...
                                <div id="empty_scanned_message"
                                    ...
                                    <p>Chưa có mã QR hợp lệ được quét!</p>
                                </div>
                            </div>
                        </div>
                    </div>
