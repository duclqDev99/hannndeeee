        ...
        <div class="row">
            <div class="col-12 mb-3">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-primary d-inline" data-bs-toggle="modal"data-type="product"
                    ...
                    <div class="flexbox-layout-sections">
                        <div class="flexbox-layout-section-primary mt20">
                            <div class="card ui-layout__item">
                                <form method="POST" action="{{ route('agent-issue.confirm', $productIssue) }}"
                                    class="form-2">
                                                ...
                                                <div class="flexbox-auto-right mr5">
                                                    <label
                                                        ...
                                                        Xuất từ: <strong>{{ $productIssue->warehouse_name }}
                                                            - {{ $productIssue->warehouseIssue->agent->name }} <i
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($productIssue->productIssueDetail as $orderProduct)
                                                            @php
                                                                ...
                                                                $quantity = AgentProduct::where(['product_id' => $orderProduct->product_id, 'warehouse_id' => $productIssue->warehouse_issue_id])?->first()?->quantity_qrcode;
                                                            @endphp
                                                            @include(
                                                                'plugins/agent::issue.batchs.product-item',
                                                                [
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="denyForm" method="post" action="{{ route('agent-issue.denied', $productIssue->id) }}">
                        @csrf
