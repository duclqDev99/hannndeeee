                                            ...
                                            <div class="flexbox-auto-right mr5">
                                                <label $class="title-product-main text-no-bold">{{ __('Phiếu xuất kho') }}
                                                    ...
                                                    Xuất từ: <strong>{{ $productIssue->warehouse_name }} <i
                                                        ...
                                                        {{ $productIssue->warehouse->name }}</strong>
                                                </label>
                                                <div>
                                                    ...
                                                    @foreach ($productIssue->productIssueDetail as $orderProduct)
                                                        <tr class="item__product">
                                                            ...
                                                            <td class="pl5 p-r5 text-center "width="30%">
                                                                SKU: <strong>{{ $orderProduct->sku }}</strong></span>
                                                            </td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="myForm" action="{{ route('agent-issue.export-file') }}"
                                method="POST">
                                @csrf
                                                ...
                                                @foreach ($actualIssue->autualDetail as $orderProduct)
                                                    <tr class="item__product">
                                                        ...
                                                        <td class="pl5 p-r5 text-center">
                                                            Số lượng: {{ $orderProduct->quantity }} SP
                                                        </td>
                                                        @php
