                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="py-3">
                                                    ...
                                                    <input class="form-control flatpickr-input" value="{{ $formattedDate }}"
                                                        ...
                                                        data-input="" readonly="readonly" name="expected_date" type="text"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="myForm" action="{{ route('proposal-agent-receipt.export-file') }}"
                                    method="POST">
                                    @csrf
                                    <input type="text" class="form-control" id="id" value="{{ $proposal->id }}"
                                        name="id" hidden="hidden">
                                    <input type="text" class="form-control" id="type_bill"
                                        value="{{ trans('plugins/warehouse::bill_export.title_form_in') }}" name="type_bill"
                                        hidden="hidden">
                                    <div class="mb-3">
                                    ...
                                    <div class="pd-all-20">
                                        <div class="card-header flexbox-grid-default">
                                            <div class="flexbox-auto-right mr5">
                                                <label
                                                    class="title-product-main text-no-bold">{{ __('Phiếu duyệt đề xuất') }}
                                                    <strong>{{ get_proposal_receipt_product_code($proposal->proposal_code) }}</strong>
                                                    - Người duyệt: {{ $proposal->invoice_confirm_name }}</label>
                                                <div>
                                                    Kho: <strong>{{ $proposal->warehouse_name }} -
                                                        {{ $proposal->warehouseReceipt->agent->name }}</strong>
