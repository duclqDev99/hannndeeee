                    ...
                    <div class="flexbox-layout-sections">
                        <div class="flexbox-layout-section-primary mt20">
                            <div class="card ui-layout__item">
                                <form method="POST" action="{{ route('agent-receipt.confirm', $productIssue) }}"
                                    class="form-2">
                                    ...
                                    <div class="wrapper-content">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="info-group">
                                                                ...
                                                                <strong>{{ $productIssue->warehouseReceipt->name }} -
                                                                    {{ $productIssue->warehouseReceipt?->agent?->name }}
                                                                </strong>
                                        ...
                                        <div class="card-footer pd-all-20 p-none-t">
                                            <div class="mt10">
                                                ...
                                                @php
                                                    echo Auth::user()->hasPermission(['agent-receipt.denied'])
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="denyForm" method="post" action="{{ route('agent-receipt.denied', $productIssue->id) }}">
                        @csrf
