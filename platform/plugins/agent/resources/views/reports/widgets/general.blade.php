...
<ul class="ecommerce-status-list list-unstyled">
    <li class="sales-this-month">
        ...
        <a class="ms-2" href="{{ route('agent.report.index') }}">
            <strong>
                {{ format_price($revenue) }}
            </strong> {{ trans('plugins/agent::reports.revenue_this_month') }}
        </a>
    </li>
    <li class="processing-orders">
        ...
        <a class="ms-2" href="{{ route('orders.index') }}">
            ...
            {{ trans('plugins/agent::reports.order_processing_this_month') }}
        </a>
    </li>
    <li class="completed-orders">
        <x-core::icon name="ti ti-truck" />
        <a class="ms-2" href="{{ route('orders.index') }}">
            <strong>{{ $completedOrders }}</strong> {{ trans('plugins/agent::reports.order_completed_this_month') }}
        </a>
    </li>
    <li class="low-in-stock">
        ...
        <a class="ms-2" href="{{ route('products.index') }}">
            ...
            {{ trans('plugins/agent::reports.product_will_be_out_of_stock') }}
        </a>
    </li>
    <li class="out-of-stock">
        ...
        <a
            ...
            <strong>{{ $outOfStockProducts }}</strong> {{ trans('plugins/agent::reports.product_out_of_stock') }}
        </a>
    </li>
</ul>
