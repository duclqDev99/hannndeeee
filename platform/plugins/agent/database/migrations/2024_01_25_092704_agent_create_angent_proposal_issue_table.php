...
return new class () extends Migration {
    ...
    {
        Schema::create('angent_proposal_issues', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('angent_proposal_issue_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('angent_proposal_issues');
        Schema::dropIfExists('angent_proposal_issue_detail');
    }
};
