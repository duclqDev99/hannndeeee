...
class ProposalAgentReceiptForm extends FormAbstract
{
    public function buildForm(): void
    {
        ...
        Assets::addScriptsDirectly([
            'vendor/core/plugins/agent/js/proposal-agent-receipt.js',
        ...
        Assets::usingVueJS();
        $this
            ->setupModel(new ProposalAgentReceipt)
            ->setValidatorClass(ProposalAgentReceiptRequest::class)
            ->addCustomField('proposal-agent-receipt-custom-field', ProposalAgentReceiptField::class)
            ->withCustomFields()
            ->add('form_title', 'html', [
            ...
            ->add('nav', 'proposal-agent-receipt-custom-field')
