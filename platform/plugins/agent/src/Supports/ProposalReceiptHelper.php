...
{
    public function makeMaterialPDF(ProposalAgentReceipt $invoice): PDFHelper|Dompdf
    {
    ...
    public function downloadInvoice(ProposalAgentReceipt $invoice): Response
    {
        return $this->makeMaterialPDF($invoice)->download(sprintf('material-%s.pdf', $invoice->proposal_code));
    }

    public function streamInvoice(ProposalAgentReceipt $invoice): Response
    {
    ...
    protected function getDataForInvoiceTemplate(ProposalAgentReceipt $invoice): array
    {
    ...
    public function getDataForPreview(): ProposalAgentReceipt
    {
        $matial = new ProposalAgentReceipt([
            'id' => 'INV-1',
