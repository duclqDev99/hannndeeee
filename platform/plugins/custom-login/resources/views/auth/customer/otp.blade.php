    ...
    <div class="row">
        <div class="col-12">
            <div class="phone">
                ...
                <h6 style="margin-bottom: 30px;">Vui lòng nhập mã OTP được gửi đến {{$phoneSendToApp}}<br> để xác minh tài khoản của bạn
                </h6>
                <span>Mã OTP đã gửi đến điện thoại của bạn</small>
                <form action="{{ route('customer.login.post') }}" method="post" id="otp-form" class="otp-form">
                    @csrf
                    ...
                    <div class="buttons">
                        <button id="btn_prev" type="button"
                            onclick="{{ route('customer.login') }}">Quay
                            lại</button>
                ...
                <div class="fw-normal text-muted mb-2">
                    Bạn chưa nhận được mã? <a
                        href="{{ route('customer.login', ['phonenumber' => $phone, 'countryCode' => $countryCode]) }}"
