...
@push('footer')
    ...
    @php
        Assets::addScriptsDirectly([
            'vendor/core/plugins/qr-scan/js/scan-batch.js'
        ]);
    @endphp
@endpush

<div class="modal fade modal-blur" id="scanBatchModal" tabindex="-1" data-select2-dropdown-parent="true" aria-modal="true"
    role="dialog">
