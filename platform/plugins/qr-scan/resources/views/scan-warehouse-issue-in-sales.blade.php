    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="save_qr_scan_btn" class="btn btn-primary save_qr_scan_btn " data-id="{{$hub_isue_id}}" type="button" name="save"
                    id="store-related-attributes-button" disabled>
                    Nhập sản phẩm
                </button>
...
@push('header')
    @php
        Assets::addStylesDirectly(['vendor/core/plugins/qr-scan/css/scan-loading.css'])
            ->addScriptsDirectly(['vendor/core/plugins/qr-scan/js/scan-warehouse-issue-in-sales.js'])
    @endphp
@endpush
@push('footer')
    <script>
