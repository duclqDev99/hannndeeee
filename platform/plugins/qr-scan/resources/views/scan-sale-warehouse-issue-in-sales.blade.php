<div class="modal fade modal-blur" id="warehouseIssueInSaleModal" tabindex="-1" role="dialog" data-select2-dropdown-parent="true"
    aria-modal="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
                ...
                <div id="box_scan">
                    ...
                    <div class="row  position-relative">
                        <div class="col tab-content overflow-y-auto" style="max-height: 400px;" id="pills-tabContent">
                            {{-- Tab lô xuất --}}
                            <div class="tab-pane fade active show" id="batch-tab" role="tabpanel"
                                aria-labelledby="pills-home-tab">
                                <div class="card border-0 position-relative mb-3">
                                    <div class="card-header border border-bottom-0">
                                        <h4 class="card-title fw-bolder">Thông tin sản phẩm</h4>
                                    </div>
                                            ...
                                            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link active" id="product-tab" data-toggle="tab"
                                                        ...
                                                        aria-selected="false">Sản phẩm nhập lại</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body p-0 overflow-y-auto">
            ...
            <div class="modal-footer">
                ...
                <button id="save_qr_scan_btn" class="btn btn-primary save_qr_scan_btn " data-id="{{$issue_id}}" type="button" name="save"
                    id="store-related-attributes-button" disabled>
                    Nhập sản phẩm
                </button>
...
@push('header')
    @php
        Assets::addStylesDirectly(['vendor/core/plugins/qr-scan/css/scan-loading.css'])
            ->addScriptsDirectly(['vendor/core/plugins/qr-scan/js/scan-sale-warehouse-issue-in-sales.js'])
    @endphp
@endpush
@push('footer')
    <script>
        ...
        window.products = @json($dataProduct);
        window.qr_products = @json($qrcode);
    </script>
@endpush
