    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Quét QR nhập kho</h5>
                        ...
                        <div class="col tab-content overflow-y-auto" style="max-height: 400px;" id="pills-tabContent">
                            <div class="tab-pane fade active" id="batch-tab" role="tabpanel"
                                ...
                                <div class="card  border-0 position-relative">
                                    <div class="card-header border border-bottom-0">
                                        <h4 class="card-title fw-bolder">Danh sách sản phẩm nhập</h4>
                                    </div>
                                    <div class="card-body p-0 overflow-y-auto">
                            ...
                            <div class="tab-pane fade" id="product-tab" role="tabpanel"
                                ...
                                <div class="overflow-auto" id="table_wrapper" >
                                    ...
                                    <div class="card border-0 position-relative">
                                        <div class="card-header border border-bottom-0">
                                            <h4 class="card-title fw-bolder">Sản phẩm nhập kho</h4>
                                        </div>
                                        <div class="card-body p-0 ">
                                            <table class="mb-0 table table-bordered ">
                                                <thead>
            ...
            <div class="modal-footer">
                <button id="save_qr_batch" class="btn btn-primary" type="button" name="save"
                    disabled>
                    Tạo lô
                </button>
...
@push('header')
    @php
        ...
        ->addScriptsDirectly(['vendor/core/plugins/qr-scan/js/scan-warehouse-receipt.js'])
    @endphp
@endpush
