...
export default {
    props: {
        ...
        type_order: {
            type: Array,
            default: [
                {name: 'Sale Promotion', value: 'sale_promotion' },
                {name: 'Sale Club', value: 'sale_club' },
                {name: 'Sale Transfer', value: 'sale_transfer' },
                {name: 'Sale Fashion', value: 'sale_fashion' },
            ]
        },
        type_order_selected: {
            type: String,
    ...
    methods: {
        ...
        createOrder: function (event, paid = false) {
            ...
            let urlRoute = route('retail.sale.purchase-order.create.store');

            if(this.child_order.id){
                urlRoute = route('retail.sale.purchase-order.update', this.child_order)
            }
