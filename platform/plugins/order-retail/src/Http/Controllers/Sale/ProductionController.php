...
class ProductionController extends BaseController
{
    ...
    {
        PageTitle::setTitle('Retail | Quản lý đơn đặt hàng');
    ...
    public function show(OrderProduction $production){
        ...
        return view('plugins/order-retail::sale.production.show', compact('production'));
    }
    ...
    public function create(FormBuilder $formBuilder)
    {
        ...
        Assets::addScriptsDirectly([
            ...
            'vendor/core/plugins/order-retail/js/create-production.js',
        ]);
    ...
    public function edit(OrderProduction $production, FormBuilder $formBuilder)
    {
        abort_if(!$production, 404, 'page not found');

        $this->pageTitle('Chỉnh sửa đơn đặt hàng');
        Assets::addScriptsDirectly([
            'vendor/core/plugins/order-retail/js/search-purchase-order.js',
        ...
        $form = ProductionForm::createFromModel($production)->setUrl(route('retail.sale.production.update', $production->id));
