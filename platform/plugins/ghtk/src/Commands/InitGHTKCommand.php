...
namespace Botble\GHTK\Commands;
...
#[AsCommand('cms:shippo:init', 'GHTK initialization')]
class InitGHTKCommand extends Command implements PromptsForMissingInput
{
    ...
    public function handle(): int
    {
        ...
        $settings = [
            ...
            'shipping_ghtk_test_key' => $key,
            'shipping_ghtk_status' => $key ? '1' : '0',
        ];
