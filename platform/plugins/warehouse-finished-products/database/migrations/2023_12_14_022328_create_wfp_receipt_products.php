...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('wfp_receipt_products', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('wfp_receipt_products_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('wfp_receipt_products');
        Schema::dropIfExists('wfp_receipt_products_detail');
    }
};
