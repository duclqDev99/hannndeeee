...
@section('content')
            ...
            <div class="col-12 mb-3">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-primary d-inline"
                        data-bs-toggle="modal"data-type="{{ $productIssue->is_batch == 0 ? 'product' : 'batch' }}"
                    ...
                    <div class="flexbox-layout-sections">
                        <div class="flexbox-layout-section-primary mt20">
                            <div class="card ui-layout__item">
                                <form method="POST" action="{{ route('product-issue.confirm', $productIssue->id) }}"
                                    class="form-2">
                                            ...
                                            <div class="card-header justify-content-between">
                                                <div class="flexbox-auto-right mr5">
                                                    <label
                                                        ...
                                                        <strong>{{ $productIssue->issue_code }}</strong> -
                                                        Xuất từ: <strong>{{ $productIssue->warehouse_name }} <i
                                                                class="fa-solid fa-arrow-right"></i>
                                                            @if ($productIssue->warehouse_type != '')
                                                ...
                                                <table class="table-order table-divided table-vcenter card-table"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($productIssue->productIssueDetail as $orderProduct)
                                                                ...
                                                                $quantity = $quantity =
                                                                    $orderProduct->size == '' || $orderProduct->color == ''
                                                                        ? ProductBatch::where([
                                                                            ...
                                                                            'warehouse_id' => $productIssue->warehouse_id,
                                                            ...
                                                            @endphp
                                                            @include(
                                                                'plugins/warehouse-finished-products::product-issue.batchs.product-item-form',
                                                                [
                                                        ...
                                                        @push('footer')
                                                            <script>
                                                                ...
                                                                window.warehouse_type = @json($productIssue->warehouse_issue_type);
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="denyForm" method="post" action="{{ route('product-issue.denied', $productIssue->id) }}">
                        @csrf
    ...
    @include('plugins/qr-scan::scan-warehouse-issue', [
        'warehouse_id' => $productIssue->warehouse_id,
        'warehouse_type' => $productIssue->warehouse_issue_type,
        'data' => $products,
    ])
    <script>
