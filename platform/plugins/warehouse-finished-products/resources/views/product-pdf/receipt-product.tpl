    ...
    <table id="table_material" class="line-items-container table-bordered">
        ...
        {% if proposal_detail %}
            {% for index,val in proposal_detail %}
                <tr>
                    <td class="center">{{proposal_detail[index]['index']+1}}</td>
                    <td>{{proposal_detail[index]['product_name']}}{{ val['attr1'] ? ', Màu: ' ~ val['attr1'] ~ ' - Size: ' ~ val['attr2'] }}</td>
                    <td class="center">{{proposal_detail[index]['sku']}}</td>
                    <td class="center">{{proposal_detail[index]['quantity']}} SP</td>
                    <td class="center">{{proposal_detail[index]['actual_qty']}} SP</td>
                    <td class="center"></td>
                    <td class="center"></td>
                </tr>
            {% endfor %}
