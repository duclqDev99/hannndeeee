 ...
 */
class ProposalReceiptProductEnum extends Enum
{
    ...
    public const REFUSERECEIPT = 'refuse_recepit';

    public static $langPath = 'plugins/warehouse-finished-products::enums.proposal-receipt';
    ...
    public function toHtml(): string|HtmlString
    {
        ...
        return match ($this->value) {
            self::DENIED => Html::tag('span', self::DENIED()->label(), ['class' => 'badge bg-danger text-danger-fg'])
                ->toHtml(),
            self::REFUSERECEIPT => Html::tag('span', self::REFUSERECEIPT()->label(), ['class' => 'badge bg-danger text-danger-fg'])
                ->toHtml(),
            ...
            self::REFUSE => Html::tag('span', self::REFUSE()->label(), ['class' => 'badge bg-warning text-warning-fg'])
                ->toHtml(),
            self::WAIT => Html::tag('span', self::WAIT()->label(), ['class' => 'badge bg-warning text-warning-fg'])
                ->toHtml(),
