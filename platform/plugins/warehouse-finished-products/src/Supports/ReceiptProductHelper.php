...
class ReceiptProductHelper
{
    ...
    public function makeMaterialPDF(ReceiptProduct $invoice): PDFHelper|Dompdf
    {
    ...
    public function downloadInvoice(ReceiptProduct $invoice): Response
    {
        return $this->makeMaterialPDF($invoice)->download(sprintf('material-%s.pdf', $invoice->proposal_code));
    }

    public function streamInvoice(ReceiptProduct $invoice): Response
    {
    ...
    protected function getDataForInvoiceTemplate(ReceiptProduct $invoice): array
    {
    ...
    public function getDataForPreview(): ReceiptProduct
    {
        $matial = new ReceiptProduct([
            'id' => 'INV-1',
